...
public class GraalvmCompilerImpl {

    private static volatile boolean compiling = true;

    public GraalvmCompilerImpl(Path buildRoot, ProjectConfiguration config) throws IOException {
    ...
    public static void executeCompileStep(GraalvmCompilerImpl dispatcher) {
    ...
    private static void executeLinkStep(GraalvmCompilerImpl dispatcher) {
        try {
    ...
    private static void executePackageStep(GraalvmCompilerImpl dispatcher) {
        try {
    ...
    private static void executeInstallStep(GraalvmCompilerImpl dispatcher) {
        try {
    ...
    private static void executeRunStep(GraalvmCompilerImpl dispatcher) {
        try {
